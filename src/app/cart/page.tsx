...
export default function CartPage() {
  ...
  const [goodsOrderId, setGoodsOrderId] = useState<number | null>(null);
    ...
    try {
      ...
      if (!prepared) {
        ...
        if (orderId == null) {
          ...
          setGoodsOrderId(orderId);
        }
        prepared = await prepareGoodsPayment(orderId, paymentMethod);
          ...
          <section className="px-4 pt-6">
            ...
            <div className="mt-6">
              <PaymentMethodSelector
                ...
                disabled={submitting}
              />
              <p className="mt-3 text-[9px] leading-[13px] text-soft">
                계좌결제는 본인 계좌 인증 후 즉시 출금되며, 현금영수증은 Payple 결제창에서 신청할 수 있습니다.
              </p>
            </div>
